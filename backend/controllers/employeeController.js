...
/**
 * @desc    Get all assigned sprints for employee
...
/**
 * @desc    Employee updates a day's plan
...
/**
 * @desc    Employee submits extension request
...
exports.requestExtension = async (req, res) => {
  try {
    ...
    const request = await ExtensionRequest.create({ 
      sprintId, userId, requestedDays, delayedDayNumber, reason, status: 'pending' 
    });
